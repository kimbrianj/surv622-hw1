...
To begin, we need to tell R what packages to load, that we will be using in our code below. Note that because the RecordLinkage package is no longer available from CRAN, we are using the latest version that we've downloaded.
...
if (!requireNamespace("RecordLinkage", quietly = TRUE)) {
  ...
  install.packages('RecordLinkage_0.4-11.2.tar.gz', repos = NULL, dependencies = TRUE, type = 'source')
}
...
```{r cache = TRUE}
sdfilepath = "~/Documents/Courses/SURV 623/Assignments/surveydata.csv"
adfilepath = "~/Documents/Courses/SURV 623/Assignments/admindata.csv"
...
```{r}
csvfilepath="~/Documents/Courses/SURV 623/Assignments/finalpairs.csv"
